...
DonorHyperglycemia$delayed_fn <- as.factor(DonorHyperglycemia$delayed_fn)

DonorHyperglycemia$d_genderf <- as.factor(DonorHyperglycemia$r_genderf)

DonorHyperglycemia$d_caucasian <- as.factor(DonorHyperglycemia$d_caucasian)
```
